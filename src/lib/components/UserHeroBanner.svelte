...
<div class="relative bg-eui-dark-blue-500 pt-0 md:bg-[transparent] md:py-16">
	<HeroBannerGraphic class="absolute bottom-0 left-0 top-0 z-10 m-auto ml-5 hidden w-fit text-white opacity-10 xl:block" />
	<div class="container relative z-10 grid grid-cols-12 pb-[calc(125px_+_2rem)] pt-8 md:py-16">
		<div class="col-span-12 text-center text-white md:col-span-8 md:pr-[150px] md:text-start lg:pr-[200px] xl:pr-[300px]">
	...
	<div class="bottom-0 left-0 right-0 top-0 grid grid-cols-12 md:absolute">
		...
		<div class="col-span-12 flex flex-col items-center justify-center bg-intranet-gray-100 pb-12 md:col-span-4 md:flex-row md:justify-start md:pb-0">
			<div class="-mt-[125px] size-[250px] min-w-[250px] overflow-hidden rounded-full border-8 border-white bg-intranet-gray-100 text-eui-dark-blue-600 md:-ml-[150px] md:mr-6 md:mt-0 md:size-[300px] md:min-w-[300px]">
				<img alt="user" class="size-full object-cover" src={getThumbnail(personalWebsite.image)} />
			</div>
			{#if personalWebsite.socialMedia.length}
				<UserHeroBannerSocials socials={personalWebsite.socialMedia} class="z-20 mt-4 flex max-h-[300px] gap-4 border-t border-slate-400 pt-4 md:mt-0 md:flex md:flex-col md:flex-wrap md:border-s md:border-t-0 md:ps-6 md:pt-0" />
			{/if}
		</div>
	</div>
</div>
