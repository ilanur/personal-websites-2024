...
<div>
	...
	>
		...
		{:else}
			...
			<HeroBannerGraphicSmall class="absolute bottom-0 right-0 top-0 z-10 m-auto mr-5 hidden text-eui-blue xl:block" />
		{/if}
		...
		<div class="bottom-0 left-0 right-0 top-0 grid grid-cols-12 md:absolute">
			...
			<div class="bg-intranet-gray-100 col-span-12 flex items-center justify-center pt-12 md:col-span-4 md:justify-start md:pt-0">
				<div
					class={clsx('bg-intranet-gray-100 overflow-hidden rounded-full border-8 border-white text-eui-blue md:mb-0 md:mr-9', {
