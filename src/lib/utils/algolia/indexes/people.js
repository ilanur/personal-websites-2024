export const peopleConfig = {
	...
	item_classes: 'col-span-1 flex flex-col divide-y divide-eui-gray-30 rounded-lg bg-white text-center shadow-md border border-eui-gray-10',
	select_form_classes: '',
	search_placeholder: 'Search by name, areas of expertise or language'
}

function templateFunction(hit) {
	let photo = hit.profile_image ? profile_image : 'https://www.eui.eu/web-production/code/assets/img/default-user-dark.jpg'
    ...
    <div>
        ...
        <div class="flex w-0 flex-1">
        	<a
					...
					>
          	<span class="fa-sharp fa-solid fa-envelope text-eui-gray-30 group-hover:text-eui-dark-blue-600 fa-lg duration-200 transition ease-out"></span>
						<span class="text-eui-gray-90 group-hover:text-eui-dark-blue-600 mt-0.5 duration-200 transition ease-out">Email</span>
          </a>
        </div>
				<div class="-ml-px flex w-0 flex-1">
					...
					>
						<span class="fa-sharp fa-solid fa-address-card text-eui-gray-30 group-hover:text-eui-dark-blue-600 fa-lg duration-200 transition ease-out"></span>   
						<span class="text-eui-gray-90 group-hover:text-eui-dark-blue-600 mt-0.5 duration-200 transition ease-out">View profile</span>
					</a>
				</div>
      </div>
    </div>
