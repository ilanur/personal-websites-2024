        ...
        <div class="relative flex items-center space-x-4">
            ...
            <div class="flex flex-col leading-tight">
                <div class="text-2xl mt-1 flex items-center">
                    <span class="text-gray-700 mr-3">EUI Intranet chatbot</span>
                </div>
                <span class="text-lg text-gray-600"
                >A technical demo of GPT super-charging EUI Intranet</span
                >
            </div>
        </div>
    </div>
        ...
        {#each messages as message (message.text)}
            <div class="chat-message">
                <div class:justify-end={message.me} class="flex items-end">
                    ...
                    <img
                    src="{message.me ? portrait : '/chatbot.png'}"
                    alt="{message.me ? 'Your profile' : 'Chatbot profile'}"
